...
//             className=" flex flex-col md:flex-row transform transition-transform ease-in-out gap-8 justify-center  rounded-3xl shadow-lg shadow-gray-600 w-[20rem] md:w-[28rem] h-[12rem] items-center border-[10px] border-indigo-400 border-r-orange-600  py-4 px-10 hover:scale-95 scroll"
//           >
//             <div className="hover:scale-95">
//               <FaGithub className="text-4xl mb-2 text-gray-600" />
//             </div>
//             <div className="text-center">
//               <p className={`text-lg font-semibold text-gray-800 text-ellipsis overflow-hidden `}>{repo.name}</p>
...
const RepositoriesPage = () => {
  ...
  return (
    <div className="flex flex-col gap-4 px-4 md:px-8 lg:px-8 xl:px-20 md:py-16 lg:py-24">
      <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-center mb-4">
        My GitHub Repositories Info App
      </h1>
      <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
